...
namespace App\Policies\Purchases\StockEntries;

use App\Models\Purchases\StockEntries\Core as PolicyModel;
...
class CorePolicy
{
    ...
    {
        return PolicyModel::hasPermission($user->user_role, 'pdf');
    }
